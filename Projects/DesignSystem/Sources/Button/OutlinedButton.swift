...
public struct OutlinedButton: View {
    ...
    private var foregroundColor: Color { disabled ? style.disabledForegroundColor : style.foregroundColor }
    ...
    private var strokeColor: Color { disabled ? .clear : style.strokeColor }
